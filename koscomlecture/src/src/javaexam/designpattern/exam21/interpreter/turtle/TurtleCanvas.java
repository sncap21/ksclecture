package javaexam.designpattern.exam21.interpreter.turtle;

import java.awt.*;

import javaexam.designpattern.exam21.interpreter.language.Executor;
import javaexam.designpattern.exam21.interpreter.language.ExecutorFactory;
...
public class TurtleCanvas extends Canvas implements ExecutorFactory {
    ...
    final static int RELATIVE_DIRECTION_RIGHT = 3; // 우향
    final static int RELATIVE_DIRECTION_LEFT = -3; // 좌향
